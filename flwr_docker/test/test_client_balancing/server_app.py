...
def main(grid: Grid, context: Context) -> None:
    ...
    # subprocess.run([f'/home/start_net.sh', f'{IPAddr}'])
    ...
    try:
        torch.save(global_model.state_dict(), "/home/final_model.pt")
    except Exception as e:
        print(f"Error saving model: {e}")

    # subprocess.run(['/home/stop_net.sh'])
    # subprocess.run(['/home/stop_monitor.sh'])