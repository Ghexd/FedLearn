...
class TrainingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Train = channel.unary_unary(
                '/Training/Train',
                request_serializer=test__pb2.TrainRequest.SerializeToString,
                response_deserializer=test__pb2.TrainReply.FromString,
...
def add_TrainingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Train': grpc.unary_unary_rpc_method_handler(
                    servicer.Train,
                    request_deserializer=test__pb2.TrainRequest.FromString,
                    response_serializer=test__pb2.TrainReply.SerializeToString,
            ),
...
class Training(object):
    ...
    def Train(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Training/Train',
            test__pb2.TrainRequest.SerializeToString,
            test__pb2.TrainReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
